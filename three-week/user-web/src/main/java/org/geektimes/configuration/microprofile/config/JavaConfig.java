...
public class JavaConfig implements Config {
    ...
    public static String getProjectName() {
        JavaSystemPropertiesConfigSource javaSystemPropertiesConfigSource = new JavaSystemPropertiesConfigSource();
        return javaSystemPropertiesConfigSource.getValue("property-name");
    }
}
